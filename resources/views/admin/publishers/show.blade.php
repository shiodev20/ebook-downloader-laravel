...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <div class="card-title">Nhà xuất bản "{{ $publisher->name }}"</div>

        <div class="row">
          <div class="col-sm-2">
            <div class="form-group mb-1">
              <label class="form-label font-weight-bold" for="title">Số lượng sách</label>
              <input class="form-control form-control-sm font-weight-bold" value="{{ $publisher->books->count() }}" readonly>
            </div>
                  ...
                  <td class="font-weight-bold">
                    <div class="d-flex justify-content-start">
                      ...
                      <x-delete-confirm-button
                          :url="route('publishers.deleteBook', ['publisher' => $publisher->id, 'book' => $book->id]) "
                          :message=" 'sách '.'<b><q>'.$book->title.'</q></b> ' . 'Khỏi NXB ' . '<b><q>'.$publisher->name.'</q></b>' "
                        >
