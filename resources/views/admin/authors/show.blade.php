...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <div class="card-title">Tác giả "{{ $author->name }}"</div>

        <div class="row">
          <div class="col-sm-2">
            <div class="form-group mb-1">
              <label class="form-label font-weight-bold" for="title">Số lượng sách</label>
              <input class="form-control form-control-sm font-weight-bold" value="{{ $author->books->count() }}" readonly>
            </div>
                  ...
                  <td class="font-weight-bold">
                    <div class="d-flex justify-content-start">
                      ...
                      <x-delete-confirm-button
                          :url="route('authors.deleteBook', ['author' => $author->id, 'book' => $book->id]) "
                          :message=" 'sách '.'<b><q>'.$book->title.'</q></b> ' . 'Khỏi tác giả ' . '<b><q>'.$author->name.'</q></b>' "
                        >
